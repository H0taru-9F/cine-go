...
import MovieModal from "@/pages/MovieDashBoard/components/MovieModal";
import ScheduleModal from "@/pages/MovieDashBoard/ScheduleModal";
import UserModal from "@/pages/UserDashBoard/component/UserModal";

//Others
import { actFetchMovieDelete } from "@/store/actions/ticket/movieManagement";
import { actGetUserDetele } from "@/store/actions/user/userManagement";
import actFetchMovieDetails from "@/store/movie/actions/movieDetails.js";
import "./style.scss";
import { actGetUserSearch } from "@/store/actions/user/userManagement";
import actGetUserList from "@/store/actions/user/userList";
