                                ...
                                <div id="panelsStayOpen-collapseOne" class="accordion-collapse collapse show" aria-labelledby="panelsStayOpen-headingOne">
                                    <div class="accordion-body">
                                        <section>
                                                <div className='row '>
                                                    <div className='col-sm-6 text-start'>
                                                        <p>After selecting the movie and session, you should choose the ticket type.
                                    ...
                                    <Form className='row justify-content-center align-items-start'>
                                        ...
                                        <div className='col-sm-12 col-md-6 mb-3'>
                                            ...
                                            <div className='row'>
                                                ...
                                                <p className='text-start'> <input class="form-check-input me-3" type="checkbox" value="" aria-label="Checkbox for following text input" required/>I have read and approve the Pre-Information Conditions and
